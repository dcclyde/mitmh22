...
host_patterns = patterns('',
    ...
    # Using `staging_heroku.py` as a template per Sahil's suggestion.
    # Our real domains.
    host(r'pure-journey-13265.herokuapp.com', 'hunt.deploy.urls.unified', name='registration', scheme='https://'),
    host(r'pure-journey-13265.herokuapp.com', 'hunt.deploy.urls.unified', name='site-1', scheme='https://'),
    host(r'pure-journey-13265.herokuapp.com', 'hunt.deploy.urls.unified', name='site-2', scheme='https://'),
